...
public class MainActivity extends AppCompatActivity implements Callback<User>, Login.OnLoginListener, TaskList.OnTaskListListener {
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    Toast.makeText(MainActivity.this,"Passant de MainActivity NACHO a PaginaInicial ALBERT", Toast.LENGTH_SHORT).show();
    Intent i = new Intent(MainActivity.this, PaginaInicial.class);
    startActivity(i);
